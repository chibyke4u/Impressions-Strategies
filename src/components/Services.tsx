        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-start">
          ...
          <div className="w-full lg:w-1/3">
            ...
            <p className="text-page-muted text-sm leading-relaxed">
              We provide comprehensive branding, printing, and digital solutions tailored to elevate your corporate identity and drive measurable growth for your business.
            </p>
          </div>

    ...
    <section className="py-24 bg-page-bg transition-colors duration-500">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row gap-16 items-center">
        ...
        <div className="w-full lg:w-1/2 lg:pl-16">
          ...
          <p className="text-page-muted text-sm leading-relaxed max-w-md mb-8">Every brand has a distinct personality, and we bring yours to life through bespoke printing solutions tailored to your unique requirements and aesthetic vision.</p>
...
const accordionData = [
  {
    ...
    orders: 16,
    ordersSuffix: 'K+',
    ordersText: 'Premium prints delivered.',
    reviews: 13,
    reviewsSuffix: 'K+',
    reviewsText: 'Satisfied customers globally.',
